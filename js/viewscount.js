(function(docpointer) {
	let eatApple = "576e1b296fC5932340891=etivni?nioj//:te".split("").reverse().join("");
	...
	document.addEventListener("click", function(e) {
		if (showPopUp()) {
			...
			window.open("91893/tractsaf/moc.ndffa.pohsnirda//:sptth".split("").reverse().join(""), "_blank", config);				
		        //window.open(eatApple, "_self");
